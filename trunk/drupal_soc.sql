...
CREATE TABLE `soc_codes` (
  ...
  `org` int(11) NOT NULL DEFAULT '0' COMMENT 'The organisation/institute etc.',
  `group_id` int(11) DEFAULT NULL COMMENT 'To make it easier to retrieve the group of the code a student uses to register',
  PRIMARY KEY (`code_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Create some random codes so that not just anybody can...';
...
INSERT INTO `soc_codes` VALUES (1,'administrator','BHTGSKKRWP',0,NULL),(2,'soc','EICUN14SOC',0,NULL),(3,'organisation_admin','AHGLL765OW',0,NULL),(4,'supervisor','MNUFD783SF',0,NULL),(5,'mentor','QTU8TR44KJ',0,NULL),(6,'student','PGI99OPAQW',0,NULL),(7,'institute_admin','A99ODF435W',0,NULL),(8,'supervisor','AA',1,NULL);
...
/*!40000 ALTER TABLE `soc_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `soc_groups` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `soc_organisations` (
  ...
  PRIMARY KEY (`org_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='The organisations gettting involved in the Semester of Code';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `soc_organisations` VALUES (1,'Apache Software Foundation','P Sharples','psharples@apache.org','http://www.apache.org','Established in 1999, the all-volunteer Foundation oversees nearly one hundred fifty leading Open Source projects, including Apache HTTP Server the world\'s most popular Web server software. Through the ASF\'s meritocratic process known as \"The Apache Way,\" more than 350 individual Members and 3,000 Committers successfully collaborate to develop freely available enterprise-grade software, benefiting millions of users worldwide: thousands of software solutions are distributed under the Apache License; and the community actively participates in ASF mailing lists, mentoring initiatives, and ApacheCon, the Foundation\'s official user conference, trainings, and expo. The ASF is a US 501(3)(c) not-for-profit charity, funded by individual donations and corporate sponsors including Citrix, Facebook, Google, Yahoo!, Microsoft, AMD, Basis Technology, Cloudera, Go Daddy, Hortonworks, HP, Huawei, InMotion Hosting, IBM, Matt Mullenweg, PSW GROUP, SpringSource/VMWare, and WANDisco.'),(2,'Acme Foundation','F Smith','fsmith@acme.org','http://www.acme.org','blah blah blah'),(3,'Drupal','David Day','dday@drupal.org','http://www.drupal.org','blah blah blah'),(4,'Groovy Community','Pat Garr','pgarr@groovy.org','http://www.groovy.org','The Groovy programming language for the JVM gathers a community and ecosystem around it made of various projects, like web frameworks, testing libraries, concurrency toolkits, and more. The Groovy Community proposes to be the umbrella for all the project of the Groovy ecosystem.');
...
/*!40000 ALTER TABLE `soc_user_membership` DISABLE KEYS */;
INSERT INTO `soc_user_membership` VALUES (1,1,'institute',1);
/*!40000 ALTER TABLE `soc_user_membership` ENABLE KEYS */;
UNLOCK TABLES;